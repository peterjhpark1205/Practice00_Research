...
SNUCHOut.rename(columns={SNUCHOut.columns[0] : 'PT_No', SNUCHOut.columns[8] : 'D_Code1', SNUCHOut.columns[9] : 'D_Name1', SNUCHOut.columns[10] : 'D_Code2', SNUCHOut.columns[11] : 'D_Name2', SNUCHOut.columns[12] : 'D_Code3', SNUCHOut.columns[13] : 'D_Name3',
...
SNUCHOut['D_Code1'] = SNUCHOut['D_Code1'].fillna('NoDiag')
SNUCHOut['D_Code1'] = SNUCHOut['D_Code1'].astype(str); SNUCHOut['D_Code1'] = SNUCHOut['D_Code1'].str.replace('/',',')
SNUCHOut['D_Name1'] = SNUCHOut['D_Name1'].fillna('NoDiag')
SNUCHOut['D_Name1'] = SNUCHOut['D_Name1'].astype(str); SNUCHOut['D_Name1'] = SNUCHOut['D_Name1'].str.replace('/',',')
SNUCHOut['D_Code2'] = SNUCHOut['D_Code2'].fillna('NoDiag')
SNUCHOut['D_Code2'] = SNUCHOut['D_Code2'].astype(str); SNUCHOut['D_Code2'] = SNUCHOut['D_Code2'].str.replace('/',',')
SNUCHOut['D_Name2'] = SNUCHOut['D_Name2'].fillna('NoDiag')
SNUCHOut['D_Name2'] = SNUCHOut['D_Name2'].astype(str); SNUCHOut['D_Name2'] = SNUCHOut['D_Name2'].str.replace('/',',')
SNUCHOut['D_Code3'] = SNUCHOut['D_Code3'].fillna('NoDiag')
SNUCHOut['D_Code3'] = SNUCHOut['D_Code3'].astype(str); SNUCHOut['D_Code3'] = SNUCHOut['D_Code3'].str.replace('/',',')
SNUCHOut['D_Name3'] = SNUCHOut['D_Name3'].fillna('NoDiag')
SNUCHOut['D_Name3'] = SNUCHOut['D_Name3'].astype(str); SNUCHOut['D_Name3'] = SNUCHOut['D_Name3'].str.replace('/',',')
SNUCHOut['D_Code4'] = SNUCHOut['D_Code4'].fillna('NoDiag')
SNUCHOut['D_Code4'] = SNUCHOut['D_Code4'].astype(str); SNUCHOut['D_Code4'] = SNUCHOut['D_Code4'].str.replace('/',',')
SNUCHOut['D_Name4'] = SNUCHOut['D_Name4'].fillna('NoDiag')
SNUCHOut['D_Name4'] = SNUCHOut['D_Name4'].astype(str); SNUCHOut['D_Name4'] = SNUCHOut['D_Name4'].str.replace('/',',')
SNUCHOut['D_Code5'] = SNUCHOut['D_Code5'].fillna('NoDiag')
SNUCHOut['D_Code5'] = SNUCHOut['D_Code5'].astype(str); SNUCHOut['D_Code5'] = SNUCHOut['D_Code5'].str.replace('/',',')
SNUCHOut['D_Name5'] = SNUCHOut['D_Name5'].fillna('NoDiag')
SNUCHOut['D_Name5'] = SNUCHOut['D_Name5'].astype(str); SNUCHOut['D_Name5'] = SNUCHOut['D_Name5'].str.replace('/',',')
SNUCHOut['D_Code6'] = SNUCHOut['D_Code6'].fillna('NoDiag')
SNUCHOut['D_Code6'] = SNUCHOut['D_Code6'].astype(str); SNUCHOut['D_Code6'] = SNUCHOut['D_Code6'].str.replace('/',',')
SNUCHOut['D_Name6'] = SNUCHOut['D_Name6'].fillna('NoDiag')
SNUCHOut['D_Name6'] = SNUCHOut['D_Name6'].astype(str); SNUCHOut['D_Name6'] = SNUCHOut['D_Name6'].str.replace('/',',')

SNUCHOut.loc[SNUCHOut.D_Code1 != 'NoDiag', 'D_Code1'] = SNUCHOut.D_Code1.str[0:4]
SNUCHOut.loc[SNUCHOut.D_Code2 != 'NoDiag', 'D_Code2'] = SNUCHOut.D_Code2.str[0:4]
SNUCHOut.loc[SNUCHOut.D_Code3 != 'NoDiag', 'D_Code3'] = SNUCHOut.D_Code3.str[0:4]
SNUCHOut.loc[SNUCHOut.D_Code4 != 'NoDiag', 'D_Code4'] = SNUCHOut.D_Code4.str[0:4]
SNUCHOut.loc[SNUCHOut.D_Code5 != 'NoDiag', 'D_Code5'] = SNUCHOut.D_Code5.str[0:4]
SNUCHOut.loc[SNUCHOut.D_Code6 != 'NoDiag', 'D_Code6'] = SNUCHOut.D_Code6.str[0:4]

SNUCHOut['D_Code'] = SNUCHOut['D_Code1']+'/'+SNUCHOut['D_Code2']+'/'+SNUCHOut['D_Code3']+'/'+SNUCHOut['D_Code4']+'/'+SNUCHOut['D_Code5']+'/'+SNUCHOut['D_Code6']
SNUCHOut['D_Name'] = SNUCHOut['D_Name1']+'/'+SNUCHOut['D_Name2']+'/'+SNUCHOut['D_Name3']+'/'+SNUCHOut['D_Name4']+'/'+SNUCHOut['D_Name5']+'/'+SNUCHOut['D_Name6']

del SNUCHOut['D_Code1']; del SNUCHOut['D_Code2']; del SNUCHOut['D_Code3']; del SNUCHOut['D_Code4']; del SNUCHOut['D_Code5']; del SNUCHOut['D_Code6']
del SNUCHOut['D_Name1']; del SNUCHOut['D_Name2']; del SNUCHOut['D_Name3']; del SNUCHOut['D_Name4']; del SNUCHOut['D_Name5']; del SNUCHOut['D_Name6']
...
SNUCHOut.to_csv('./SNUCH/SNUCHOutP_R4A.csv', index=False)
