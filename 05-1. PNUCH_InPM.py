...
PNUCHIn.rename(columns={PNUCHIn.columns[0] : 'PT_No', PNUCHIn.columns[1] : 'Birth', PNUCHIn.columns[2] : 'Gender', PNUCHIn.columns[3] : 'Address', PNUCHIn.columns[5] : 'Ins_Var',
                        ...
                        PNUCHIn.columns[11] : 'In_Prd', PNUCHIn.columns[12] : 'DRGNO', PNUCHIn.columns[13] : 'D_Code', PNUCHIn.columns[14] : 'D_Name', PNUCHIn.columns[15] : 'D_Code2',
...
# Diagnosis
PNUCHIn['D_Code'] = PNUCHIn['D_Code'].fillna('NoDiag')
PNUCHIn['D_Code'] = PNUCHIn['D_Code'].astype(str); PNUCHIn['D_Code'] = PNUCHIn['D_Code'].str.replace('/',',')
PNUCHIn['D_Name'] = PNUCHIn['D_Name'].fillna('NoDiag')
PNUCHIn['D_Name'] = PNUCHIn['D_Name'].astype(str); PNUCHIn['D_Name'] = PNUCHIn['D_Name'].str.replace('/',',')


PNUCHIn.loc[PNUCHIn.D_Code != 'NoDiag', 'D_Code'] = PNUCHIn.D_Code.str[0:4]

del PNUCHIn['D_Code2']; del PNUCHIn['D_Code3']; del PNUCHIn['D_Code4']; del PNUCHIn['D_Code5']
del PNUCHIn['D_Name2']; del PNUCHIn['D_Name3']; del PNUCHIn['D_Name4']; del PNUCHIn['D_Name5']
...
PNUCHIn.to_csv('./PNUCH/PNUCHInPMain_R4A.csv', index=False)
