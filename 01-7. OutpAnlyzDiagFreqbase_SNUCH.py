...
SNUCHOut = pd.read_csv("./SNUCH/SNUCHOutP_R4A.csv", low_memory=False, encoding="utf-8")
...
SNUCHOutDiagF_base50.to_csv('./SNUCH/SNUCH 외래환자 진단 빈도별 순위.csv', encoding='cp949', index=False)

SNUCHOutDiagF_base.to_csv('./SNUCH/(원)SNUCH 외래환자 진단 빈도별 순위.csv', encoding='cp949', index=False)
