...
SNUCHInDiagF_base50.to_csv('./SNUCH/SNUCH 입원환자 주진단 빈도별 순위 (기본 사항).csv', encoding='cp949', index=False)
SNUCHInDiagF_svty50.to_csv('./SNUCH/SNUCH 입원환자 주진단 빈도별 순위 (중증도 분류).csv', encoding='cp949', index=False)


SNUCHInDiagF_base.to_csv('./SNUCH/(원)SNUCH 입원환자 주진단 빈도별 순위 (기본 사항).csv', encoding='cp949', index=False)
SNUCHInDiagF_svty.to_csv('./SNUCH/(원)SNUCH 입원환자 주진단 빈도별 순위 (중증도 분류).csv', encoding='cp949', index=False)
