...
KBNUCHOut = pd.read_csv("./KBNUCH/KBNUCHOutP_R4A.csv", low_memory=False, encoding="utf-8")
...
KBNUCHOutDiagF_base50.to_csv('./KBNUCH/KBNUCH 외래환자 진단 빈도별 순위.csv', encoding='cp949', index=False)

KBNUCHOutDiagF_base.to_csv('./KBNUCH/(원)KBNUCH 외래환자 진단 빈도별 순위.csv', encoding='cp949', index=False)
