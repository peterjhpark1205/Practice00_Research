...
JBNUCHOut = pd.read_csv("./JBNUCH/JBNUCHOutP_R4A.csv", low_memory=False, encoding="utf-8")
...
JBNUCHOutDiagF_base50.to_csv('./JBNUCH/JBNUCH 외래환자 진단 빈도별 순위.csv', encoding='cp949', index=False)

JBNUCHOutDiagF_base.to_csv('./JBNUCH/(원)JBNUCH 외래환자 진단 빈도별 순위.csv', encoding='cp949', index=False)
