...
SNUCHIn = pd.read_csv("./SNUCH/SNUCHInPMain_R4A.csv", encoding="utf-8")
#KNUCHIn = pd.read_csv("./KNUCH/KNUCHInPMain_R4A.csv", encoding="utf-8")
#SACHIn = pd.read_csv("./SACH/SACHInPMain_R4A.csv", encoding="utf-8")
#SCHIn = pd.read_csv("./SCH/SCHInPMain_R4A.csv", encoding="utf-8")
...
AllIn.to_csv('./All/AllInPMain_R4A.csv', index=False)
...
AllInDiagF_base50.to_csv('./All/All 입원환자 주진단 빈도별 순위 (기본 사항).csv', encoding='cp949', index=False)
AllInDiagF_svty50.to_csv('./All/All 입원환자 주진단 빈도별 순위 (중증도 분류).csv', encoding='cp949', index=False)

AllInDiagF_base.to_csv('./All/(원)All 입원환자 주진단 빈도별 순위 (기본 사항).csv', encoding='cp949', index=False)
AllInDiagF_svty.to_csv('./All/(원)All 입원환자 주진단 빈도별 순위 (중증도 분류).csv', encoding='cp949', index=False)
