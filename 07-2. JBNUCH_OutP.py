...
JBNUCHOut.rename(columns={JBNUCHOut.columns[0] : 'PT_No', JBNUCHOut.columns[1] : 'Birth', JBNUCHOut.columns[2] : 'Gender', JBNUCHOut.columns[3] : 'Address',
                          JBNUCHOut.columns[4] : 'Out_Date', JBNUCHOut.columns[5] : 'Out_Dep', JBNUCHOut.columns[6] : 'D_Code1', JBNUCHOut.columns[7] : 'D_Name1',
...
JBNUCHOut['D_Code1'] = JBNUCHOut['D_Code1'].replace('없음', 'NoDiag')
JBNUCHOut['D_Code1'] = JBNUCHOut['D_Code1'].astype(str); JBNUCHOut['D_Code1'] = JBNUCHOut['D_Code1'].str.replace('/',',')
JBNUCHOut['D_Name1'] = JBNUCHOut['D_Name1'].replace('없음', 'NoDiag')
JBNUCHOut['D_Name1'] = JBNUCHOut['D_Name1'].astype(str); JBNUCHOut['D_Name1'] = JBNUCHOut['D_Name1'].str.replace('/',',')
JBNUCHOut['D_Code2'] = JBNUCHOut['D_Code2'].replace('없음', 'NoDiag')
JBNUCHOut['D_Code2'] = JBNUCHOut['D_Code2'].astype(str); JBNUCHOut['D_Code2'] = JBNUCHOut['D_Code2'].str.replace('/',',')
JBNUCHOut['D_Name2'] = JBNUCHOut['D_Name2'].replace('없음', 'NoDiag')
JBNUCHOut['D_Name2'] = JBNUCHOut['D_Name2'].astype(str); JBNUCHOut['D_Name2'] = JBNUCHOut['D_Name2'].str.replace('/',',')
JBNUCHOut['D_Code3'] = JBNUCHOut['D_Code3'].replace('없음', 'NoDiag')
JBNUCHOut['D_Code3'] = JBNUCHOut['D_Code3'].astype(str); JBNUCHOut['D_Code3'] = JBNUCHOut['D_Code3'].str.replace('/',',')
JBNUCHOut['D_Name3'] = JBNUCHOut['D_Name3'].replace('없음', 'NoDiag')
JBNUCHOut['D_Name3'] = JBNUCHOut['D_Name3'].astype(str); JBNUCHOut['D_Name3'] = JBNUCHOut['D_Name3'].str.replace('/',',')
JBNUCHOut['D_Code4'] = JBNUCHOut['D_Code4'].replace('없음', 'NoDiag')
JBNUCHOut['D_Code4'] = JBNUCHOut['D_Code4'].astype(str); JBNUCHOut['D_Code4'] = JBNUCHOut['D_Code4'].str.replace('/',',')
JBNUCHOut['D_Name4'] = JBNUCHOut['D_Name4'].replace('없음', 'NoDiag')
JBNUCHOut['D_Name4'] = JBNUCHOut['D_Name4'].astype(str); JBNUCHOut['D_Name4'] = JBNUCHOut['D_Name4'].str.replace('/',',')
JBNUCHOut['D_Code5'] = JBNUCHOut['D_Code5'].replace('없음', 'NoDiag')
JBNUCHOut['D_Code5'] = JBNUCHOut['D_Code5'].astype(str); JBNUCHOut['D_Code5'] = JBNUCHOut['D_Code5'].str.replace('/',',')
JBNUCHOut['D_Name5'] = JBNUCHOut['D_Name5'].replace('없음', 'NoDiag')
JBNUCHOut['D_Name5'] = JBNUCHOut['D_Name5'].astype(str); JBNUCHOut['D_Name5'] = JBNUCHOut['D_Name5'].str.replace('/',',')
JBNUCHOut['D_Code6'] = JBNUCHOut['D_Code6'].fillna('NoDiag')
JBNUCHOut['D_Code6'] = JBNUCHOut['D_Code6'].astype(str); JBNUCHOut['D_Code6'] = JBNUCHOut['D_Code6'].str.replace('/',',')
JBNUCHOut['D_Name6'] = JBNUCHOut['D_Name6'].fillna('NoDiag')
JBNUCHOut['D_Name6'] = JBNUCHOut['D_Name6'].astype(str); JBNUCHOut['D_Name6'] = JBNUCHOut['D_Name6'].str.replace('/',',')

JBNUCHOut.loc[JBNUCHOut.D_Code1 != 'NoDiag', 'D_Code1'] = JBNUCHOut.D_Code1.str[0:4]
JBNUCHOut.loc[JBNUCHOut.D_Code2 != 'NoDiag', 'D_Code2'] = JBNUCHOut.D_Code2.str[0:4]
JBNUCHOut.loc[JBNUCHOut.D_Code3 != 'NoDiag', 'D_Code3'] = JBNUCHOut.D_Code3.str[0:4]
JBNUCHOut.loc[JBNUCHOut.D_Code4 != 'NoDiag', 'D_Code4'] = JBNUCHOut.D_Code4.str[0:4]
JBNUCHOut.loc[JBNUCHOut.D_Code5 != 'NoDiag', 'D_Code5'] = JBNUCHOut.D_Code5.str[0:4]
JBNUCHOut.loc[JBNUCHOut.D_Code6 != 'NoDiag', 'D_Code6'] = JBNUCHOut.D_Code6.str[0:4]

JBNUCHOut['D_Code'] = JBNUCHOut['D_Code1']+'/'+JBNUCHOut['D_Code2']+'/'+JBNUCHOut['D_Code3']+'/'+JBNUCHOut['D_Code4']+'/'+JBNUCHOut['D_Code5']+'/'+JBNUCHOut['D_Code6']
JBNUCHOut['D_Name'] = JBNUCHOut['D_Name1']+'/'+JBNUCHOut['D_Name2']+'/'+JBNUCHOut['D_Name3']+'/'+JBNUCHOut['D_Name4']+'/'+JBNUCHOut['D_Name5']+'/'+JBNUCHOut['D_Name6']

del JBNUCHOut['D_Code1']; del JBNUCHOut['D_Code2']; del JBNUCHOut['D_Code3']; del JBNUCHOut['D_Code4']; del JBNUCHOut['D_Code5']; del JBNUCHOut['D_Code6']
del JBNUCHOut['D_Name1']; del JBNUCHOut['D_Name2']; del JBNUCHOut['D_Name3']; del JBNUCHOut['D_Name4']; del JBNUCHOut['D_Name5']; del JBNUCHOut['D_Name6']
...
JBNUCHOut.to_csv('./JBNUCH/JBNUCHOutP_R4A.csv', index=False)
