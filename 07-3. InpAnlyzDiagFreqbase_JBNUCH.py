...
JBNUCHInDiagF_base50.to_csv('./JBNUCH/JBNUCH 입원환자 진단 빈도별 순위 (기본 사항).csv', encoding='cp949', index=False)
JBNUCHInDiagF_svty50.to_csv('./JBNUCH/JBNUCH 입원환자 진단 빈도별 순위 (중증도 분류).csv', encoding='cp949', index=False)


JBNUCHInDiagF_base.to_csv('./JBNUCH/(원)JBNUCH 입원환자 진단 빈도별 순위 (기본 사항).csv', encoding='cp949', index=False)
JBNUCHInDiagF_svty.to_csv('./JBNUCH/(원)JBNUCH 입원환자 진단 빈도별 순위 (중증도 분류).csv', encoding='cp949', index=False)
