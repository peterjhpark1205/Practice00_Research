...
KBNUCHOut.rename(columns={KBNUCHOut.columns[0] : 'PT_No', KBNUCHOut.columns[1] : 'Birth', KBNUCHOut.columns[2] : 'Gender', KBNUCHOut.columns[3] : 'Address',
                          KBNUCHOut.columns[5] : 'Out_Date', KBNUCHOut.columns[6] : 'Out_Dep', KBNUCHOut.columns[7] : 'D_Code', KBNUCHOut.columns[8] : 'D_Name',
...
KBNUCHOut['D_Code'] = KBNUCHOut['D_Code'].fillna('NoDiag')
KBNUCHOut['D_Code'] = KBNUCHOut['D_Code'].astype(str); KBNUCHOut['D_Code'] = KBNUCHOut['D_Code'].str.replace('/',',')
KBNUCHOut['D_Name'] = KBNUCHOut['D_Name'].fillna('NoDiag')
KBNUCHOut['D_Name'] = KBNUCHOut['D_Name'].astype(str); KBNUCHOut['D_Name'] = KBNUCHOut['D_Name'].str.replace('/',',')


KBNUCHOut.loc[KBNUCHOut.D_Code != 'NoDiag', 'D_Code'] = KBNUCHOut.D_Code.str[0:4]


del KBNUCHOut['D_Code2']; del KBNUCHOut['D_Code3']; del KBNUCHOut['D_Code4']; del KBNUCHOut['D_Code5']; del KBNUCHOut['D_Code6']
del KBNUCHOut['D_Name2']; del KBNUCHOut['D_Name3']; del KBNUCHOut['D_Name4']; del KBNUCHOut['D_Name5']; del KBNUCHOut['D_Name6']
...
KBNUCHOut.to_csv('./KBNUCH/KBNUCHOutPMain_R4A.csv', index=False)
