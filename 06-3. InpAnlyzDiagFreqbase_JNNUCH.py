...
JNNUCHInDiagF_base50.to_csv('./JNNUCH/JNNUCH 입원환자 진단 빈도별 순위 (기본 사항).csv', encoding='cp949', index=False)
JNNUCHInDiagF_svty50.to_csv('./JNNUCH/JNNUCH 입원환자 진단 빈도별 순위 (중증도 분류).csv', encoding='cp949', index=False)

JNNUCHInDiagF_base.to_csv('./JNNUCH/(원)JNNUCH 입원환자 진단 빈도별 순위 (기본 사항).csv', encoding='cp949', index=False)
JNNUCHInDiagF_svty.to_csv('./JNNUCH/(원)JNNUCH 입원환자 진단 빈도별 순위 (중증도 분류).csv', encoding='cp949', index=False)
