...
JBNUCHIn.rename(columns={JBNUCHIn.columns[1] : 'PT_No', JBNUCHIn.columns[3] : 'Birth', JBNUCHIn.columns[4] : 'Gender', JBNUCHIn.columns[5] : 'Address', JBNUCHIn.columns[7] : 'Ins_Var',
                         ...
                         JBNUCHIn.columns[15] : 'In_Prd', JBNUCHIn.columns[16] : 'DRGNO', JBNUCHIn.columns[17] : 'D_Code1', JBNUCHIn.columns[18] : 'D_Name1', JBNUCHIn.columns[19] : 'D_Code2',
...
# Diagnosis
JBNUCHIn['D_Code1'] = JBNUCHIn['D_Code1'].fillna('NoDiag')
JBNUCHIn['D_Code1'] = JBNUCHIn['D_Code1'].astype(str); JBNUCHIn['D_Code1'] = JBNUCHIn['D_Code1'].str.replace('/',',')
JBNUCHIn['D_Name1'] = JBNUCHIn['D_Name1'].fillna('NoDiag')
JBNUCHIn['D_Name1'] = JBNUCHIn['D_Name1'].astype(str); JBNUCHIn['D_Name1'] = JBNUCHIn['D_Name1'].str.replace('/',',')
JBNUCHIn['D_Code2'] = JBNUCHIn['D_Code2'].fillna('NoDiag')
JBNUCHIn['D_Code2'] = JBNUCHIn['D_Code2'].astype(str); JBNUCHIn['D_Code2'] = JBNUCHIn['D_Code2'].str.replace('/',',')
JBNUCHIn['D_Name2'] = JBNUCHIn['D_Name2'].fillna('NoDiag')
JBNUCHIn['D_Name2'] = JBNUCHIn['D_Name2'].astype(str); JBNUCHIn['D_Name2'] = JBNUCHIn['D_Name2'].str.replace('/',',')
JBNUCHIn['D_Code3'] = JBNUCHIn['D_Code3'].fillna('NoDiag')
JBNUCHIn['D_Code3'] = JBNUCHIn['D_Code3'].astype(str); JBNUCHIn['D_Code3'] = JBNUCHIn['D_Code3'].str.replace('/',',')
JBNUCHIn['D_Name3'] = JBNUCHIn['D_Name3'].fillna('NoDiag')
JBNUCHIn['D_Name3'] = JBNUCHIn['D_Name3'].astype(str); JBNUCHIn['D_Name3'] = JBNUCHIn['D_Name3'].str.replace('/',',')
JBNUCHIn['D_Code4'] = JBNUCHIn['D_Code4'].fillna('NoDiag')
JBNUCHIn['D_Code4'] = JBNUCHIn['D_Code4'].astype(str); JBNUCHIn['D_Code4'] = JBNUCHIn['D_Code4'].str.replace('/',',')
JBNUCHIn['D_Name4'] = JBNUCHIn['D_Name4'].fillna('NoDiag')
JBNUCHIn['D_Name4'] = JBNUCHIn['D_Name4'].astype(str); JBNUCHIn['D_Name4'] = JBNUCHIn['D_Name4'].str.replace('/',',')
JBNUCHIn['D_Code5'] = JBNUCHIn['D_Code5'].fillna('NoDiag')
JBNUCHIn['D_Code5'] = JBNUCHIn['D_Code5'].astype(str); JBNUCHIn['D_Code5'] = JBNUCHIn['D_Code5'].str.replace('/',',')
JBNUCHIn['D_Name5'] = JBNUCHIn['D_Name5'].fillna('NoDiag')
JBNUCHIn['D_Name5'] = JBNUCHIn['D_Name5'].astype(str); JBNUCHIn['D_Name5'] = JBNUCHIn['D_Name5'].str.replace('/',',')
JBNUCHIn['D_Code6'] = JBNUCHIn['D_Code6'].fillna('NoDiag')
JBNUCHIn['D_Code6'] = JBNUCHIn['D_Code6'].astype(str); JBNUCHIn['D_Code6'] = JBNUCHIn['D_Code6'].str.replace('/',',')
JBNUCHIn['D_Name6'] = JBNUCHIn['D_Name6'].fillna('NoDiag')
JBNUCHIn['D_Name6'] = JBNUCHIn['D_Name6'].astype(str); JBNUCHIn['D_Name6'] = JBNUCHIn['D_Name6'].str.replace('/',',')

JBNUCHIn.loc[JBNUCHIn.D_Code1 != 'NoDiag', 'D_Code1'] = JBNUCHIn.D_Code1.str[0:4]
JBNUCHIn.loc[JBNUCHIn.D_Code2 != 'NoDiag', 'D_Code2'] = JBNUCHIn.D_Code2.str[0:4]
JBNUCHIn.loc[JBNUCHIn.D_Code3 != 'NoDiag', 'D_Code3'] = JBNUCHIn.D_Code3.str[0:4]
JBNUCHIn.loc[JBNUCHIn.D_Code4 != 'NoDiag', 'D_Code4'] = JBNUCHIn.D_Code4.str[0:4]
JBNUCHIn.loc[JBNUCHIn.D_Code5 != 'NoDiag', 'D_Code5'] = JBNUCHIn.D_Code5.str[0:4]
JBNUCHIn.loc[JBNUCHIn.D_Code6 != 'NoDiag', 'D_Code6'] = JBNUCHIn.D_Code6.str[0:4]

JBNUCHIn['D_Code'] = JBNUCHIn['D_Code1']+'/'+JBNUCHIn['D_Code2']+'/'+JBNUCHIn['D_Code3']+'/'+JBNUCHIn['D_Code4']+'/'+JBNUCHIn['D_Code5']+'/'+JBNUCHIn['D_Code6']
JBNUCHIn['D_Name'] = JBNUCHIn['D_Name1']+'/'+JBNUCHIn['D_Name2']+'/'+JBNUCHIn['D_Name3']+'/'+JBNUCHIn['D_Name4']+'/'+JBNUCHIn['D_Name5']+'/'+JBNUCHIn['D_Name6']

del JBNUCHIn['D_Code1']; del JBNUCHIn['D_Code2']; del JBNUCHIn['D_Code3']; del JBNUCHIn['D_Code4']; del JBNUCHIn['D_Code5']; del JBNUCHIn['D_Code6']
del JBNUCHIn['D_Name1']; del JBNUCHIn['D_Name2']; del JBNUCHIn['D_Name3']; del JBNUCHIn['D_Name4']; del JBNUCHIn['D_Name5']; del JBNUCHIn['D_Name6']
...
JBNUCHIn.to_csv('./JBNUCH/JBNUCHInP_R4A.csv', index=False)
