...
KBNUCHIn.rename(columns={KBNUCHIn.columns[0] : 'PT_No', KBNUCHIn.columns[1] : 'Birth', KBNUCHIn.columns[2] : 'Gender', KBNUCHIn.columns[3] : 'Address', KBNUCHIn.columns[5] : 'Ins_Var',
                         ...
                         KBNUCHIn.columns[11] : 'In_Prd', KBNUCHIn.columns[12] : 'DRGNO', KBNUCHIn.columns[13] : 'D_Code', KBNUCHIn.columns[14] : 'D_Name', KBNUCHIn.columns[15] : 'D_Code2',
...
# Diagnosis
KBNUCHIn['D_Code'] = KBNUCHIn['D_Code'].fillna('NoDiag')
KBNUCHIn['D_Code'] = KBNUCHIn['D_Code'].astype(str); KBNUCHIn['D_Code'] = KBNUCHIn['D_Code'].str.replace('/',',')
KBNUCHIn['D_Name'] = KBNUCHIn['D_Name'].fillna('NoDiag')
KBNUCHIn['D_Name'] = KBNUCHIn['D_Name'].astype(str); KBNUCHIn['D_Name'] = KBNUCHIn['D_Name'].str.replace('/',',')


KBNUCHIn.loc[KBNUCHIn.D_Code != 'NoDiag', 'D_Code'] = KBNUCHIn.D_Code.str[0:4]


del KBNUCHIn['D_Code2']; del KBNUCHIn['D_Code3']; del KBNUCHIn['D_Code4']; del KBNUCHIn['D_Code5']; del KBNUCHIn['D_Code6']
del KBNUCHIn['D_Name2']; del KBNUCHIn['D_Name3']; del KBNUCHIn['D_Name4']; del KBNUCHIn['D_Name5']; del KBNUCHIn['D_Name6']
...
print(KBNUCHIn.columns)
print(KBNUCHIn.loc[310:320, : ])



### Save as CSV in '/Users/peterpark/Desktop/PY_START/SNUH_Project01'

KBNUCHIn.to_csv('./KBNUCH/KBNUCHInPMain_R4A.csv', index=False)
