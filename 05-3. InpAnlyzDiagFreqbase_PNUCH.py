...
PNUCHInDiagF_base50.to_csv('./PNUCH/PNUCH 입원환자 진단 빈도별 순위 (기본 사항).csv', encoding='cp949', index=False)
PNUCHInDiagF_svty50.to_csv('./PNUCH/PNUCH 입원환자 진단 빈도별 순위 (중증도 분류).csv', encoding='cp949', index=False)


PNUCHInDiagF_base.to_csv('./PNUCH/(원)PNUCH 입원환자 진단 빈도별 순위 (기본 사항).csv', encoding='cp949', index=False)
PNUCHInDiagF_svty.to_csv('./PNUCH/(원)PNUCH 입원환자 진단 빈도별 순위 (중증도 분류).csv', encoding='cp949', index=False)
