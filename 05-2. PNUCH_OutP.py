...
PNUCHOut.rename(columns={PNUCHOut.columns[0] : 'PT_No', PNUCHOut.columns[1] : 'Birth', PNUCHOut.columns[2] : 'Gender', PNUCHOut.columns[3] : 'Address',
                          PNUCHOut.columns[4] : 'Out_Date', PNUCHOut.columns[5] : 'Out_Dep', PNUCHOut.columns[6] : 'D_Code1', PNUCHOut.columns[7] : 'D_Name1',
...
PNUCHOut['D_Code1'] = PNUCHOut['D_Code1'].fillna('NoDiag')
PNUCHOut['D_Code1'] = PNUCHOut['D_Code1'].astype(str); PNUCHOut['D_Code1'] = PNUCHOut['D_Code1'].str.replace('/',',')
PNUCHOut['D_Name1'] = PNUCHOut['D_Name1'].fillna('NoDiag')
PNUCHOut['D_Name1'] = PNUCHOut['D_Name1'].astype(str); PNUCHOut['D_Name1'] = PNUCHOut['D_Name1'].str.replace('/',',')
...
PNUCHOut.loc[PNUCHOut.D_Code1 != 'NoDiag', 'D_Code1'] = PNUCHOut.D_Code1.str[0:4]
PNUCHOut.loc[PNUCHOut.D_Code2 != 'NoDiag', 'D_Code2'] = PNUCHOut.D_Code2.str[0:4]
PNUCHOut.loc[PNUCHOut.D_Code3 != 'NoDiag', 'D_Code3'] = PNUCHOut.D_Code3.str[0:4]
PNUCHOut.loc[PNUCHOut.D_Code4 != 'NoDiag', 'D_Code4'] = PNUCHOut.D_Code4.str[0:4]
PNUCHOut.loc[PNUCHOut.D_Code5 != 'NoDiag', 'D_Code5'] = PNUCHOut.D_Code5.str[0:4]
PNUCHOut.loc[PNUCHOut.D_Code6 != 'NoDiag', 'D_Code6'] = PNUCHOut.D_Code6.str[0:4]

PNUCHOut['D_Code'] = PNUCHOut['D_Code1']+'/'+PNUCHOut['D_Code2']+'/'+PNUCHOut['D_Code3']+'/'+PNUCHOut['D_Code4']+'/'+PNUCHOut['D_Code5']+'/'+PNUCHOut['D_Code6']
PNUCHOut['D_Name'] = PNUCHOut['D_Name1']+'/'+PNUCHOut['D_Name2']+'/'+PNUCHOut['D_Name3']+'/'+PNUCHOut['D_Name4']+'/'+PNUCHOut['D_Name5']+'/'+PNUCHOut['D_Name6']

del PNUCHOut['D_Code1']; del PNUCHOut['D_Code2']; del PNUCHOut['D_Code3']; del PNUCHOut['D_Code4']; del PNUCHOut['D_Code5']; del PNUCHOut['D_Code6']
del PNUCHOut['D_Name1']; del PNUCHOut['D_Name2']; del PNUCHOut['D_Name3']; del PNUCHOut['D_Name4']; del PNUCHOut['D_Name5']; del PNUCHOut['D_Name6']
...
PNUCHOut.to_csv('./PNUCH/PNUCHOutP_R4A.csv', index=False)
