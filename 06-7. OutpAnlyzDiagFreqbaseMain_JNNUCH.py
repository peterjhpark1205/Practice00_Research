...
JNNUCHOut = pd.read_csv("./JNNUCH/JNNUCHOutPMain_R4A.csv", low_memory=False, encoding="utf-8")
...
JNNUCHOutDiagF_base50.to_csv('./JNNUCH/JNNUCH 외래환자 주진단 빈도별 순위.csv', encoding='cp949', index=False)


JNNUCHOutDiagF_base.to_csv('./JNNUCH/(원)JNNUCH 외래환자 주진단 빈도별 순위.csv', encoding='cp949', index=False)
